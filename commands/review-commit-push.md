Fully agentic loop: review the current git changes for real potential bugs, fix any real bugs found, re-review, then commit all changes and push. Do not ask for user input unless you cannot confidently fix a real bug. Follow these steps:
...
10. Push to the current branch (use `git push origin HEAD`)
