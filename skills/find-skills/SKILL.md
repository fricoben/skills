...
description: >
  ...
  the user is looking for functionality that might exist as an installable
  skill. Trigger terms: find skill, search skills, install skill, discover
  skill, skill for, how do I.
---
