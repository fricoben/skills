# AI Writing Patterns Catalog (24 patterns)
...
Remove entirely when found in published text.

### 20. Knowledge-Cutoff Disclaimers

**Words to watch:** as of [date], Up to my last training update, While specific details are limited/scarce..., based on available information...

Remove and replace with sourced facts.

### 21. Sycophantic/Servile Tone

Replace overly positive, people-pleasing language with direct responses.
